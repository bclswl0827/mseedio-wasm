...
func (m *IMPL_ms_seedtimestr2nstime) Call(timeStr string) (int64, error) {
	if m.Ctx == nil {
	...
	if m.FunctionObj == nil {
		return 0, fmt.Errorf("ms_seedtimestr2nstime function is nil")
	}
	...
	if err != nil {
		return 0, fmt.Errorf("failed to call ms_seedtimestr2nstime: %w", err)
	}
