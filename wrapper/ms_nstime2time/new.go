...
func New(ctx context.Context, mutex *sync.Mutex, function api.Function, valuePointerHandler utils.ValuePointerHandler) *IMPL_ms_nstime2time {
	return &IMPL_ms_nstime2time{
