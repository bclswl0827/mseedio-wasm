...
func New(ctx context.Context, mutex *sync.Mutex, function api.Function, stringHandler utils.StringHandler) *IMPL_ms_mdtimestr2nstime {
	return &IMPL_ms_mdtimestr2nstime{
